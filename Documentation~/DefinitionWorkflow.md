# Camera-Navigation: definition workflow
...
3. Use its buttons to exercise frame with c#, frame with component.
4. Inspect the configured hosts and triggers, then open
   [CameraNavigationWorkflow.cs](../Samples~/DefinitionWorkflow/Runtime/CameraNavigationWorkflow.cs). It is the caller
...
- **Frame with C#**: `CameraNavigationWorkflow.Frame()`.
- **Frame with component**: `CameraNavigationWorkflow.FrameComponent()`.
